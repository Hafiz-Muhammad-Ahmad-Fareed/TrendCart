...
//           <div
//             key={i}
//             className="flex flex-col justify-between rounded-3xl border border-gray-800 bg-gray-900/40 p-6 backdrop-blur-sm"
//           >
...
//               {isCategoriesLoading ? "..." : stat.value}
//             </div>
//           </div>
//         ))}
//       </div>
...
//       {/* Modal Section - Same logic as provided */}
//       {isModalOpen && (
//         <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 overflow-y-auto">
//           <section
//             ref={modalRef}
//             className="w-full max-w-md rounded-3xl border border-gray-800 bg-gray-900 p-6 shadow-2xl animate-in fade-in zoom-in duration-200"
//           >
...
import useAdminStore from "../stores/useAdminStore";
import useOnClickOutside from "../hooks/useOnClickOutside";
import SummaryCard from "../components/SummaryCard"; // Assuming this is the path
