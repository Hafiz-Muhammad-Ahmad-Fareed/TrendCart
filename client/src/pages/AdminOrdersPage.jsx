...
//                           <div
//                             className={`inline-flex items-center gap-1.5 w-fit px-2.5 py-1 rounded-full border text-xs font-semibold capitalize ${getStatusColor(order.status)}`}
//                           >
...
//                                       No shipping address provided (Digital or
//                                       Incomplete)
//                                     </p>
//                                   )}
//                                 </div>
